#ifndef _TEST_INTEGER_VECTOR__
#define _TEST_INTEGER_VECTOR__

#include "../../misc/bit_sequence.h"

#define IV_SEQENCE_LEN 100
#define IV_PRINT_SEQUENCES false

/* void _test_integer_vector(GraphRef Graph__, uint64_t* sequence) {
  int32_t i;
  Graph_Line line;
...
void test_integer_rear_insert(void) {
  int32_t i;
...
void test_integer_front_insert(void) {
  int32_t i;
